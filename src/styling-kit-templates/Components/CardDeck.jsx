/* 
    ...
    Details Component -- The <CardDeck> component is a container to create a grid of cards that are of equal height and width
*/
import React, { Component } from "react"
import styled from 'styled-components'
import { CardDeck } from '@bootstrap-styled/v4'
...
const StyledCardDeck = styled(CardDeck).attrs((props) => ({ 
    className: ''
})
)``


export default class MyStyledCardDeck extends Component {
    render(){
        const {...props} = this.props
        const { children } = this.props
        return(
            <StyledCardDeck {...props} theme={theme.init}>
                {children}
            </StyledCardDeck>
        )
    }
